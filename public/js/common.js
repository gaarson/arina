...
$(document).ready(function () {
	$(document).scroll(function (e) {
		...
		var coord = $(".career").offset();

		if (($(window).height() + $(window).scrollTop() >= coord.top * 1.5) && ($(window).scrollTop() - (coord.top * 1.5) < 0)) {
...
//
//$('.inner').css('width', '' + $widthImg + 'px').css('height', '' + $heightImg + 'px');
});
